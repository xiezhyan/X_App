...
import com.sanq.product.core.ui.camera.Camera;
import com.sanq.product.core.ui.camera.CameraImageBean;
import com.sanq.product.core.ui.camera.RequestCodes;
import com.sanq.product.core.ui.scanner.ScannerDelegate;
...
public abstract class PermissionCheckerDelegate extends BaseDelegates {
    ...
    //扫描二维码(不直接调用)
    @NeedsPermission(Manifest.permission.CAMERA)
    void startScan(BaseDelegates delegate) {
