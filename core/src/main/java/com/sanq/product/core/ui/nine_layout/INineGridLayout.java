...
public abstract class INineGridLayout extends ViewGroup {
    ...
    public INineGridLayout(Context context) {
        super(context);
        init(context);
    }

    public INineGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
