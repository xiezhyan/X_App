package com.sanq.product.core.widget;
...
public final class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    public AutoPhotoLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIconText = typedArray.getString(R.styleable.camera_flow_layout_icon_text);
        typedArray.recycle();
    }

    public final void setDelegate(PermissionCheckerDelegate delegate) {
